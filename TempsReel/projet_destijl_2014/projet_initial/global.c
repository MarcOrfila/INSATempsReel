...
int PRIORITY_TENVOYER = 25;   // Pour éviter les segfaults, il faut que la priorité de tenvoyer soit supérieure à toutes celles des fonctions qui utilisent un write in queue
int PRIORITY_TBATTERIE = 5; 
int PRIORITY_TMISSION = 50;
int PRIORITY_TWATCHDOG = 40;
int PRIORITY_TCAMERA = 28;
